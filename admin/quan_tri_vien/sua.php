						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input name="id" class="form-control" type="hidden" required value="<?php echo $row['id'] ?>">
									<input name="ten" class="form-control" required value="<?php echo $row['ten'] ?>">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
                            ...
                            <div class="col-md-6">
								<div class="form-group">
									...
									<input name="new-pw" type="password" class="form-control" placeholder="Thêm mật khẩu mới?">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Số điện thoại</label>
									<input name="sdt" type="tel" class="form-control" value="<?php echo $row['sdt'] ?>" required>
								</div>
							</div>
